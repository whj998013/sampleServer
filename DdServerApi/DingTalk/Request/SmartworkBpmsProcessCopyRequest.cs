...
{
    /// <summary>
    /// TOP API: dingtalk.smartwork.bpms.process.copy
    /// </summary>
    public class SmartworkBpmsProcessCopyRequest : BaseDingTalkRequest<DingTalk.Api.Response.SmartworkBpmsProcessCopyResponse>
    {
        /// <summary>
        /// 企业微应用标识
        /// </summary>
